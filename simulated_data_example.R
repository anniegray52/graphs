## to do:
# 3. do i use all the packages/what for
# 4. do i need all the code to perfectly replicate figures
# 5. python file for node2vec
# 6. add r packages and python to file 
...
## to plot first three dimensions of \hat{X}
...
## create graph and check it is connected
